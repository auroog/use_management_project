...
class User(Base):
    ...
    role: Mapped[UserRole] = mapped_column(SQLAlchemyEnum(UserRole, name='UserRole', create_constraint=True), nullable=False)
    ...
    verification_token_expiry = mapped_column(DateTime, nullable=True)
